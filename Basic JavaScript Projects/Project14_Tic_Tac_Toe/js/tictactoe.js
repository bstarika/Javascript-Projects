...
let activePlayer= 'X';
//This array stores an array of moves to determine win conditions
let selectedSquares = [];
    ...
    function computersTurn() {
        ...
        while(!success){
            ...
            if (placeXOrO(pickASquare)) {
                ...
                //This changes boolean and ends loop
                success=true;
            };
        }
    }
...
//drawWinLine function is called to draw line if condiiton is met
function checkWinConditions() {
    ...
    //This function checks if array includes 3 strings and checks for each win condition
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    x = x1,
    //This is variable stores temporary y axis data we update in our animation loop
    y = y1;
    ...
    function animateLineDrawing() {
        ...
        if (xl <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition cancels animation loop
    ...
    //This function clears our canvas after our win line is dawn
    function clear() {
